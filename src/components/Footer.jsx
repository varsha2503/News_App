...
const Footer = () => {
    return (
        ...
        <div className='d-flex bg-dark justify-content-center align-items-center vh-50 p-3' style={{borderTop:"2px solid white"}}>
            <div className="text-center">
                {/* Developer name */}
                <p style={{fontSize: "20px", color: "white", textDecoration:"underline"}} >Developed By</p>
                <h3 style={{fontSize: "50px", color: "Orange"}}>VARSHA</h3>
